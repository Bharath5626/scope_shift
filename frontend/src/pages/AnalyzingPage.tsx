...
function BrainIcon() {
  return (
    <svg viewBox="0 0 80 80" fill="none" className="h-full w-full">
      ...
      />
      {/* vertical line */}
      <line x1="40" y1="27" x2="40" y2="55" stroke="#14ddf8" strokeWidth="1.5" strokeDasharray="3 2" />
      {/* horizontal curves */}
      <path d="M33 32 Q36 35 33 38" stroke="#14ddf8" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M47 32 Q44 35 47 38" stroke="#14ddf8" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <circle cx="33" cy="45" r="2.5" fill="#14ddf8" opacity="0.5" />
      <circle cx="47" cy="45" r="2.5" fill="#14ddf8" opacity="0.5" />
    </svg>
  )
}
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-4 sm:p-8">
      <div className="relative overflow-hidden rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-surface)] shadow-lg w-full max-w-md px-6 sm:px-10 py-8 sm:py-12 text-center dark:border-[var(--border-secondary)]">
       ...
       <div className="absolute left-0 top-0 h-full w-1.5 bg-gradient-to-b from-[var(--color-primary)] to-[#0891b2] rounded-l-2xl" />
        ...
        {!analysisStarted ? (
          <>
            ...
            <div className="mt-6">
              <p className="text-sm text-[var(--text-soft)] dark:text-[var(--text-subtle)]">
                Auto-analyzing in <span className="font-semibold text-[var(--color-primary)] dark:text-[var(--color-primary)]">{countdown}s</span>
              </p>
            </div>
          ...
          <>
            ...
            <div className="relative h-2 w-full overflow-hidden rounded-full bg-[var(--bg-section)] dark:bg-[var(--bg-section)]">
              <div
                className="h-full rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[#0891b2] transition-all duration-500 ease-out"
            ...
            <div className="mt-3 flex items-center justify-between text-xs text-[var(--text-subtle)] dark:text-[var(--text-soft)]">
              ...
              <span className="ml-3 shrink-0 font-medium text-[var(--color-primary)] dark:text-[var(--color-primary)]">
