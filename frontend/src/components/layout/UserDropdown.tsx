...
export function UserDropdown({
  ...
  return (
    <div
      className={`${positionClass} w-56 ${BORDER_RADIUS.modal} bg-white/95 backdrop-blur-md shadow-xl ring-1 ring-black/5 overflow-hidden dark:bg-gray-800/95 dark:ring-gray-700`}
      role="menu"
    ...
    >
      <div className="py-1">
        <button
          ...
          className={`flex w-full items-center gap-3 px-4 py-2.5 ${TYPOGRAPHY.body} text-gray-700 hover:bg-gray-100 ${TRANSITION} dark:!text-black dark:hover:bg-gray-700`}
          role="menuitem"
        >
