    ...
    >
      <div className="py-1">
        <button
          ...
          className={`flex w-full items-center gap-3 px-4 py-2.5 ${TYPOGRAPHY.body} text-[var(--text-secondary)] hover:bg-[var(--bg-section)] ${TRANSITION} dark:text-gray-200 dark:hover:bg-gray-700`}
          role="menuitem"
        >
